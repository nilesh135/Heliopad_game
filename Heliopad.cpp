...
void frontsheet(void)
{
	...
	Write(-0.50, 0.9, 1, 0.0007, (char*)"K J Somaiya College Of Engineering");
	...
	Write(-1.0, -0.03, 0.0, 0.0006, (char*) "1. Nileshkumar Jha:1711086");
	Write(-1.0, -0.13, 0.0, 0.0006, (char*) "2. Shubham Dathia: 1911072");
	Write(-1.0, -0.13, 0.0, 0.0006, (char*) "3. Ansh Bandral: 1911067");
	glColor3f(1, 1, 0.0);
	Write(-1.0, -0.4, 0.0, 0.0007, (char*) " Under the guidance of: ");
	glColor3f(1.0, 1.0, 1.0);
	Write(0.15, -0.415, 0.0, 0.0006, (char*) " 1. Vaibhav Vasani");
	glFlush();
}
